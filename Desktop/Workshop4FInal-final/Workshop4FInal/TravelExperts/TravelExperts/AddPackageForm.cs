...
namespace ProductSupplier
{
    public partial class AddPackageForm : Form
    {
        ...
        private void AddPackageForm_Load(object sender, EventArgs e)
        {
            ...
            {
                this.Text=$"Package {currentPackage.PackageId} Description";
        ...
        private void DisplayCurrentProductSupplier()
        {
            ...
            packageNameTextbox.Text = currentPackage.PkgName;
            startDateTime.Text = currentPackage.PkgStartDate.ToString();
            endDateTime.Text = currentPackage.PkgEndDate.ToString();
            packageDescriptionTextbox.Text = currentPackage.PkgDesc;
            basePriceTextbox.Text = currentPackage.PkgBasePrice.ToString();
            agencyCommissionTextbox.Text = currentPackage.PkgAgencyCommission.ToString();
